    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/production/**").authenticated()
                        .requestMatchers(HttpMethod.GET, "/energy/**").hasAnyRole("ADMIN", "PRODUCTION_MANAGER", "ENERGY_MANAGER", "VIEWER")
                        .requestMatchers(HttpMethod.GET, "/downtime/**").hasAnyRole("ADMIN", "PRODUCTION_MANAGER", "VIEWER")
                        .requestMatchers(HttpMethod.GET, "/quality/**").hasAnyRole("ADMIN", "PRODUCTION_MANAGER", "VIEWER")
                        .requestMatchers(HttpMethod.GET, "/dashboard/**").authenticated()
                        .requestMatchers(HttpMethod.GET, "/anomalies/**").authenticated()
                        .requestMatchers(HttpMethod.PATCH, "/anomalies/*/status").hasAnyRole("ADMIN", "PRODUCTION_MANAGER", "ENERGY_MANAGER")
                        .requestMatchers(HttpMethod.POST, "/anomalies/rerun").hasRole("ADMIN")
