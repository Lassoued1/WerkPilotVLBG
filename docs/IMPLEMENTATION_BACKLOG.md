...
| WP-S2-08 Fixtures and 100k benchmark | Done | S2-03..06 | §34; NFR-03; TEST-02 | Four valid/invalid fixture families, expected counts and recorded benchmark. | `.\mvnw.cmd "-Dtest=LargeCsvImportBenchmarkIT" verify` |
...
| WP-S4-06 Maintenance domain, overdue and APIs | In review | S1-02, S1-04 | MNT-01..07; §22.2; OQ-012 | Lifecycle, assignment-first sorting, comments/audit, due date and computed overdue are implemented; integration proof awaits Docker access. | `.\mvnw.cmd "-Dtest=MaintenanceTicketLifecycleIT,TicketOverdueCalculationTest" verify` |
| WP-S4-07 Anomaly-to-ticket and recurring pattern | In review | S4-03, S4-06 | MNT-02; AN-04; ACC-07 | Linked creation/status, anomaly detail link, machine history linkage and recurring-ticket detection are implemented; integration proof awaits Docker access. | `.\mvnw.cmd "-Dtest=AnomalyToTicketIT,RecurringTicketPatternIT" verify` |
| WP-S4-08 Maintenance UI | In review | S0-06, S4-06, S4-07 | §25; ACC-07 | German assigned-first list/detail, transitions, notes, comments, overdue badge and anomaly conversion are implemented. | `npm test -- --run src/features/maintenance` |
